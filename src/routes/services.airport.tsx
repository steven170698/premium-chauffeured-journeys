  ...
  head: () => ({
    meta: [
      { title: "Airport Transportation — JFK, LGA, EWR | Stevie Services LLC" },
      {
        name: "description",
        content:
          "Reliable airport transfers to and from JFK, LaGuardia, and Newark. Flight tracking, meet-and-greet, and on-time guarantee.",
      },
  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-16">
      ...
      <h1 className="mt-3 font-display text-4xl font-semibold sm:text-5xl">
        JFK · LGA · EWR — on time, every time
      </h1>
      <div className="mt-8 space-y-6 text-muted-foreground leading-relaxed">
        <p>
          We monitor your flight in real time and adjust pickup to actual arrival, so early or
          delayed doesn't cost you anything. Complimentary wait time on airport pickups.
        </p>
        <p>
          Every airport trip includes: professional greeting, luggage assistance, bottled water, and
          phone chargers. Clean, comfortable 2024 Honda CR-V with room for up to 4 passengers.
        </p>
