  ...
  head: () => ({
    meta: [
      { title: "Hourly Chauffeur Service | Stevie Services LLC" },
      {
        name: "description",
        content:
          "Book a professional chauffeur by the hour for meetings, shopping, events, or a full day of appointments across NY and NJ.",
      },
  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-16">
      ...
      <h1 className="mt-3 font-display text-4xl font-semibold sm:text-5xl">
        Your driver, on your schedule
      </h1>
      <div className="mt-8 space-y-6 text-muted-foreground leading-relaxed">
        <p>
          Reserve a professional chauffeur by the hour for as long as you need. Perfect for
          back-to-back meetings, shopping trips, medical appointments, or a full day out.
        </p>
